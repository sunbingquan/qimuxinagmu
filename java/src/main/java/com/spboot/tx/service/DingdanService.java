...
public class DingdanService {
    ...
    public QueryWrapper<Dingdan> mapToWrapper(Map<String, Object> map) {
        ...
        if (!StringUtil.isNullOrEmpty(map.get("zhuangtai"))) {
            wrapper.eq("zhuangtai", map.get("zhuangtai"));
        }
    ...
    public ResponseData insert(Dingdan entityData, Map post) {
        ...
        if (entityData.getId() != null) {
            ...
            DB.execute(
                "INSERT INTO dingdanshangpin(dingdanid,jiajuid,bianhao,mingcheng,fenlei,pinpai,tupian,jiage,shuliang,xiaoji,goumairen)  SELECT '" +
                charuid +
                "',jiajuid,bianhao,mingcheng,fenlei,pinpai,tupian,jiage,shuliang,xiaoji,goumairen  FROM gouwuche  WHERE goumairen='" +
