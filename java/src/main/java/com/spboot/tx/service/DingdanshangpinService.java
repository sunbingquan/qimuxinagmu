...
public class DingdanshangpinService {
    ...
    public ResponseData<Dingdanshangpin> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Dingdanshangpin>> selectAll(Wrapper<Dingdanshangpin> query) {
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Dingdanshangpin>> filter(Map<String, Object> map) {
        Class<Dingdanshangpin> aClass = Dingdanshangpin.class;
        com.jntoo.db.QueryWrapper<Dingdanshangpin> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Dingdanshangpin> wrapper, IPage page) {
    ...
    public ResponseData insert(Dingdanshangpin entityData, Map post) {
        Info.handlerNullEntity(entityData);

        mapper.insert(entityData);
        if (entityData.getId() != null) {
            Integer charuid = entityData.getId();
            DB.execute("UPDATE dingdanshangpin SET xiaoji=(jiage*shuliang) WHERE id='" + charuid + "'");
    ...
    public ResponseData<Object> update(Dingdanshangpin entityData, Map post) {
        mapper.updateById(entityData);

        Integer charuid = entityData.getId();
        DB.execute("UPDATE dingdanshangpin SET xiaoji=(jiage*shuliang) WHERE id='" + post.get("id") + "'");
