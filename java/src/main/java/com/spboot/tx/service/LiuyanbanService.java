...
@Service
public class LiuyanbanService {

    @Resource
    private LiuyanbanMapper mapper;

    public ResponseData<Liuyanban> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Liuyanban>> selectAll(Wrapper<Liuyanban> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Liuyanban>> selectAll() {
        QueryWrapper<Liuyanban> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Liuyanban> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Liuyanban> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Liuyanban> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Liuyanban>> filter(Map<String, Object> map) {
        Class<Liuyanban> aClass = Liuyanban.class;
        com.jntoo.db.QueryWrapper<Liuyanban> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Liuyanban> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Liuyanban entityData, Map post) {
    ...
    public ResponseData<Object> update(Liuyanban entityData, Map post) {
