...
public class LunbotuService {
    ...
    @Resource
    private LunbotuMapper mapper;

    public ResponseData<Lunbotu> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Lunbotu>> selectAll(Wrapper<Lunbotu> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Lunbotu>> selectAll() {
        QueryWrapper<Lunbotu> wrapper = Wrappers.query();
    ...
    public ResponseData selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Lunbotu> wrapper = mapToWrapper(map);
    ...
    public QueryWrapper<Lunbotu> mapToWrapper(Map<String, Object> map) {
        QueryWrapper<Lunbotu> wrapper = Wrappers.query();
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Lunbotu>> filter(Map<String, Object> map) {
        Class<Lunbotu> aClass = Lunbotu.class;
        com.jntoo.db.QueryWrapper<Lunbotu> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Lunbotu> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Lunbotu entityData, Map post) {
    ...
    public ResponseData<Object> update(Lunbotu entityData, Map post) {
