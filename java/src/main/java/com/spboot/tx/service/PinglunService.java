...
public class PinglunService {
    ...
    public ResponseData<Pinglun> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Pinglun>> selectAll(Wrapper<Pinglun> query) {
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Pinglun>> filter(Map<String, Object> map) {
        Class<Pinglun> aClass = Pinglun.class;
        com.jntoo.db.QueryWrapper<Pinglun> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Pinglun> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Pinglun entityData, Map post) {
    ...
    public ResponseData<Object> update(Pinglun entityData, Map post) {
