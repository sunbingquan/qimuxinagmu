...
public class ShouhuodizhiService {
    ...
    public ResponseData<Shouhuodizhi> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Shouhuodizhi>> selectAll(Wrapper<Shouhuodizhi> query) {
    ...
    public QueryWrapper<Shouhuodizhi> mapToWrapper(Map<String, Object> map) {
        ...
        if (!StringUtil.isNullOrEmpty(map.get("lianxidianhua"))) {
            wrapper.like("lianxidianhua", map.get("lianxidianhua"));
        }
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Shouhuodizhi>> filter(Map<String, Object> map) {
        Class<Shouhuodizhi> aClass = Shouhuodizhi.class;
        com.jntoo.db.QueryWrapper<Shouhuodizhi> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Shouhuodizhi> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Shouhuodizhi entityData, Map post) {
    ...
    public ResponseData<Object> update(Shouhuodizhi entityData, Map post) {
