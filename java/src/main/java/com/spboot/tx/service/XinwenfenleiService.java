...
public class XinwenfenleiService {
    ...
    public ResponseData<Xinwenfenlei> findById(Integer id) {
        return JsonResult.success(mapper.selectById(id));
    }

    public ResponseData<List<Xinwenfenlei>> selectAll(Wrapper<Xinwenfenlei> query) {
        return JsonResult.success(mapper.selectList(query));
    }

    public ResponseData<List<Xinwenfenlei>> selectAll() {
     ...
     * @return 搜索到得数据
     */
    public ResponseData<List<Xinwenfenlei>> filter(Map<String, Object> map) {
        Class<Xinwenfenlei> aClass = Xinwenfenlei.class;
        com.jntoo.db.QueryWrapper<Xinwenfenlei> wrapper = DB.name(aClass);
    ...
    public ResponseData selectPages(QueryWrapper<Xinwenfenlei> wrapper, IPage page) {
        Map result = new HashMap();
        result.put("lists", mapper.selectPage(page, wrapper));
        return JsonResult.success(result);
    }

    public ResponseData insert(Xinwenfenlei entityData, Map post) {
    ...
    public ResponseData<Object> update(Xinwenfenlei entityData, Map post) {
