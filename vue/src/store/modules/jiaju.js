...
const actions = {
    selectAll(
        ...
        return new Promise((resolve, reject) => {
            if (content.state.status == 0) {
                ...
                http.get("/api/jiaju/selectAll").then(
                    (res) => {
                        if (res.code == 0) {
    ...
    findById(content, id) {
        return new Promise((resolve, reject) => {
            http.get("/api/jiaju/findById", { id }).then((res) => {
                if (res.code == 0) {
                    resolve(res.data);
                } else {
                    reject(res.msg);
    ...
    filter(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/jiaju/filter", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    query(content, data) {
        // 分页查询数据
        return new Promise((resolve, reject) => {
            http.post("/api/jiaju/selectPages", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    update(content, data) {
        // 更新数据
        return new Promise((resolve, reject) => {
            http.post("/api/jiaju/update", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    insert(content, data) {
        // 插入数据
        return new Promise((resolve, reject) => {
            http.post("/api/jiaju/insert", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    delete(content, data) {
        // 删除数据
        return new Promise((resolve, reject) => {
            http.post("/api/jiaju/delete", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
