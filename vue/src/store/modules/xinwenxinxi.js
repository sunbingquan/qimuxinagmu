...
const actions = {
    ...
    findById(content, id) {
        return new Promise((resolve, reject) => {
            http.get("/api/xinwenxinxi/findById", { id }).then((res) => {
                if (res.code == 0) {
                    resolve(res.data);
                } else {
                    reject(res.msg);
    ...
    filter(content, data) {
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenxinxi/filter", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    query(content, data) {
        // 分页查询数据
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenxinxi/selectPages", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    update(content, data) {
        // 更新数据
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenxinxi/update", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    insert(content, data) {
        // 插入数据
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenxinxi/insert", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
    ...
    delete(content, data) {
        // 删除数据
        return new Promise((resolve, reject) => {
            http.post("/api/xinwenxinxi/delete", data)
                .json()
                .then(
                    (res) => {
                        if (res.code == 0) {
