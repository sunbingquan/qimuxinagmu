        ...
        <el-card class="box-card">
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    <el-form-item label="权限">
                        <el-select v-model="search.cx"><el-option label="请选择" value=""></el-option><el-option label="管理员" value="管理员"></el-option> </el-select>
                    </el-form-item>
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="权限" width="80">
                    <template slot-scope="{row}"> {{ row.cx }} </template>
                </el-table-column>
        ...
        methods: {
            ...
            deleteItems(items) {
                this.$confirm("确定删除数据？此操作不可恢复", "警告", {
                    ...
                    this.$store.dispatch("admins/delete", ids).then((res) => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
