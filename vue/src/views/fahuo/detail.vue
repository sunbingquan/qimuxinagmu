<template>
    <div class="fahuo-detail" v-loading="loading" ref="print">
        <el-page-header @back="goBack" content="详情页面"></el-page-header>
        <div class="admin-detail">
            <div class="detail detail-readmodule">
                <div class="detail-title">订单id：</div>
                <div class="detail-content">{{ map.dingdanid }}</div>
            </div>
            ...
            <div class="detail detail-text">
                ...
                <div class="detail-content">{{ map.xiangxidizhi }}</div>
            </div>
            <div class="detail detail-text">
            ...
            <div class="detail detail-text">
                <div class="detail-title">快递电话：</div>
                <div class="detail-content">{{ map.kuaididianhua }}</div>
            </div>
