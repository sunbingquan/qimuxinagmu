    ...
    <div class="fahuo-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix updt">
                <el-page-header @back="$router.go(-1)" content="编辑发货"> </el-page-header>
            </div>
            <div class="form-database-form">
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item
                        ...
                        prop="kuaididanhao"
                        required
                        :rules="[{required:true, message:'请填写快递单号'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'update', module:'fahuo', col:'kuaididanhao', id:form.id, trigger:'blur'}]"
                    >
    ...
    export default {
        ...
        methods: {
            ...
            loadInfo() {
                ...
                this.loading = true;
                this.$store
                    .dispatch("fahuo/findById", this.id)
                    .then((res) => {
                        this.loading = false;
                        this.form = res;
                        formUtil.loadInfo(res.dingdanid).then((rs) => {
