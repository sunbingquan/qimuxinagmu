    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        <el-card class="box-card">
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    <el-form-item label="分类名">
                        <el-input v-model="search.fenleiming"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="分类名" width="130">
                    <template slot-scope="{row}"> {{ row.fenleiming }} </template>
                </el-table-column>
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/fenleiupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
        ...
        methods: {
            ...
            deleteItems(items) {
                this.$confirm("确定删除数据？此操作不可恢复", "警告", {
                    ...
                    this.$store.dispatch("fenlei/delete", ids).then((res) => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
