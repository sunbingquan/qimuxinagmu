        ...
        <el-card class="box-card">
            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="数量">
                        <el-input type="text" style="width: 80px" v-model="search.shuliang_start"></el-input>
                        -
                        <el-input type="text" style="width: 80px" v-model="search.shuliang_end"></el-input>
                    </el-form-item>
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="数量" width="80">
                    <template slot-scope="{row}"> {{ row.shuliang }} </template>
                </el-table-column>
