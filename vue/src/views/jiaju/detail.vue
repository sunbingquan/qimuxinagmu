<template>
    <div class="jiaju-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-text">
                ...
                <div class="detail-content">{{ map.pinpai }}</div>
            </div>
            ...
            <div class="detail detail-select">
                ...
                <div class="detail-content">
                    <e-select-view module="fenlei" :value="map.fenlei" select="id" show="fenleiming"></e-select-view>
                </div>
            </div>
            ...
            <div class="detail detail-number">
                <div class="detail-title">销量：</div>
                <div class="detail-content">{{ map.xiaoliang }}</div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$store
                    .dispatch("jiaju/findById", this.id)
                    .then((res) => {
                        this.loading = false;
                        this.map = res;
                    })
