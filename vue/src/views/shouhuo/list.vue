                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/shouhuodetail',query:{id:row.id } })" icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/shouhuoupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
        ...
        methods: {
            ...
            deleteItems(items) {
                this.$confirm("确定删除数据？此操作不可恢复", "警告", {
                    ...
                    this.$store.dispatch("shouhuo/delete", ids).then((res) => {
                        this.loading = false;
                        if (res.code != api.code.OK) {
