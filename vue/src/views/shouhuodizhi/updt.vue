        ...
        <el-card class="box-card">
            ...
            <div class="form-database-form">
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="联系电话" prop="lianxidianhua" :rules="[{validator:rule.checkTel, message:'请输入正确固定号码'}]">
    ...
    export default {
        ...
        methods: {
            submit() {
                this.$refs.formModel
                    ...
                    .then((res) => {
                        ...
                        this.$store
                            .dispatch("shouhuodizhi/update", form)
                            .then((res) => {
                                this.loading = false;
                                if (res.code == 0) {
            ...
            loadInfo() {
                ...
                this.loading = true;
                this.$store
                    .dispatch("shouhuodizhi/findById", this.id)
                    .then((res) => {
                        this.loading = false;
                        this.form = res;
                    })
