        ...
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row @selection-change="handleSelectionChange">
                ...
                <el-table-column label="年龄" width="80">
                    <template slot-scope="{row}"> {{ row.nianling }} </template>
                </el-table-column>
                ...
                <el-table-column label="住址" width="130">
                    <template slot-scope="{row}"> {{ row.zhuzhi }} </template>
                </el-table-column>
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({path:'/admin/wxuserdetail',query:{id:row.id } })" icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
